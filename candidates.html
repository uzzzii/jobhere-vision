...
<!-- Mirrored from preview.hasthemes.com/jobhere-v1/candidates.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 May 2023 06:44:00 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Candidates || JobHere</title>
                ...
                <div class="container">
                    <div class="all-job-post">
                        ...
                        <div class="post-tab nav">
                            <a class="nav-link" data-toggle="tab" href="#featured">FULL TIME</a>
                            <a class="nav-link  active" data-toggle="tab" href="#recent_job">PART TIME</a>
                            <a class="nav-link" data-toggle="tab" href="#featured">FREELANCER</a>
                            <a class="nav-link" data-toggle="tab" href="#recent_job">FREELANCER</a>
                        </div>                            
                        <!-- Tab panes -->
                            ...
                            <div class="tab-pane active" id="featured">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/2.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/3.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/4.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/5.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/6.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/7.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-job-post">
                                             <div class="img-icon">
                                                <img src="images/candidates/8.jpg" alt="">
                                            </div>
                                            <div class="address">
                                                <h6>Applicant Name</h6>
                                                <p><span>Designation</span></p>
...
<!-- Mirrored from preview.hasthemes.com/jobhere-v1/candidates.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 May 2023 06:44:03 GMT -->
</html>