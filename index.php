                                        ...
                                        <div class="text-content-wrapper">
                                            <div class="text-content text-center">
                                                ...
                                                <div class="banner-readmore wow bounceInUp mt-35" data-wow-duration="3s" data-wow-delay="2s">
                                                    <a class="button slider-btn" href="about.php">ABOUT US</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="single-job-post">
                                            ...
                                            <div class="button-box"><a href="job-board.php" class="button button-black">APPLY NOW</a></div>
                                        </div>
                                    </div>
                                    <!-- Single Item Start -->
                                    <!-- Single Item Start -->
                    ...
                    <div class="blog-carousel carousel-style-two">
                        ...
                        <div class="single-blog hover-effect">
                            <div class="blog-image box-hover">
                                <a href="job-board.php" class="block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3">
                                <div class="single-footer-widget">
                                    ...
                                    <ul class="footer-list">
                                        <li><a href="contact.php">Sudia Region</a></li>
                                        <li><a href="contact.php">North America</a></li>
                                        <li><a href="contact.php">Africa</a></li>
                                        <li><a href="contact.php">China</a></li>
                                        <li><a href="contact.php">Brazil</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3 d-md-none d-lg-block">
                                <div class="single-footer-widget">
                                    ...
                                    <ul class="footer-list">
                                        <li><a href="job-details.php">Full Time Job</a></li>
                                        <li><a href="job-details.php">Part Time Job</a></li>
                                        <li><a href="job-details.php">Temporary Job</a></li>
                                        <li><a href="job-details.php">Internship Job</a></li>
                                        <li><a href="job-details.php">Developer</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4">
                                <div class="single-footer-widget">
                                    ...
                                    <ul class="footer-list">
                                        <li><a href="job-details.php">Graphic Designer</a></li>
                                        <li><a href="job-details.php">HTML Designer</a></li>
                                        <li><a href="job-details.php">WP Developer</a></li>
                                        <li><a href="job-details.php">Joomla Developer</a></li>
                                        <li><a href="job-details.php">Content Writer</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="footer-text">
                                    <span class="text-white block">
                                        Copyright&copy;
                                        <a href="job-details.php">Jobhere</a>
                                        .All right reserved.
                                    </span>
                                </div>
                            </div>
